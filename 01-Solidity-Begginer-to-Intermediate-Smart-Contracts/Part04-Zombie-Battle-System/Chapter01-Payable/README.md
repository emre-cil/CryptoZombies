...
But in Ethereum, because the money (_Ether_), the data (_transaction payload_), and the contract code itself all live on Ethereum, it's possible for you to call a function **_and_** pay money to the contract at the same time.
