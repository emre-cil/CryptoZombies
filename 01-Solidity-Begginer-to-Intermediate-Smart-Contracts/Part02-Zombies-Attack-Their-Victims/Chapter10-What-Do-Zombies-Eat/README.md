...
Don't worry — our game isn't actually going to hurt anyone's CryptoKitty. We're only _reading_ the CryptoKitties data, we're not able to actually delete it 😉
